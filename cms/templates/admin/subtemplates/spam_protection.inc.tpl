...
<textarea id="not_accepted_words" class="form-control" name="not_accepted_words" rows="7"><?php if(isset($not_accepted_words)) echo stripslashes($not_accepted_words);  ?></textarea>
</div>
...
<input id="akismet_key" class="form-control" type="text" name="akismet_key" value="<?php echo $akismet_key; ?>">
</div>

<div class="checkbox">
<label>
<input id="akismet_entry_check" type="checkbox" name="akismet_entry_check"<?php if(isset($akismet_entry_check) && $akismet_entry_check==1): ?> checked<?php endif; ?>> <?php echo $lang['akismet_entry_check']; ?>
</label><br />
<label>
<input id="akismet_mail_check" type="checkbox" name="akismet_mail_check"<?php if(isset($akismet_mail_check) && $akismet_mail_check==1): ?> checked<?php endif; ?>> <?php echo $lang['akismet_mail_check']; ?>
</label>
</div>
