...
<?php if($pagination['previous']): ?> <a href="<?php echo BASE_URL . PAGE; ?>,<?php echo IMAGE_IDENTIFIER; ?>,<?php echo $photo_data['id']; ?>,0,1<?php if($pagination['previous']>1): ?>,<?php echo $pagination['previous']; endif; ?>#comments">&laquo;</a> <?php endif; ?>
...
<?php endforeach; ?>
<?php if($pagination['next']): ?> <a href="<?php echo BASE_URL . PAGE; ?>,<?php echo IMAGE_IDENTIFIER; ?>,<?php echo $photo_data['id']; ?>,0,1,<?php echo $pagination['next']; ?>#comments">&raquo;</a><?php endif; ?>  
]</p>
<?php endif; ?>
