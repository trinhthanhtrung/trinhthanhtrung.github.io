...
<h1><a href="index.php"><?php echo $lang['administration']; ?></a> &raquo; <a href="index.php?mode=menus"><?php echo $lang['menus']; ?></a> &raquo; <a href="index.php?mode=menus&amp;edit=<?php echo $menu_data['menu']; ?>"><?php echo str_replace('[menu]', $menu_data['menu'], $lang['edit_menu_hl']); ?></a> &raquo; <?php echo $lang['edit_menu_item']; ?></h1>
